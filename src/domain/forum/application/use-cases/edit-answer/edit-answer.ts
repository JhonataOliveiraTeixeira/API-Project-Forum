...
export class EditAnswerUseCase {
  ...
  async execute({
    ...
    const currentAnswerAttchaments = await this.answerAttachemntRepository.findManyByAnswerId(answerId)

    const answerAttachemntList = new AnswerAttachmentList(currentAnswerAttchaments)
