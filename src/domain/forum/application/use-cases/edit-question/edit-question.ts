...
export class EditQuestionUseCase {
  ...
  async execute({
    ...
    const currentQuestionAttchaments = await this.questionAttachmentRepository.findManyByQuestionId(questionId)

    const questionAttachemntList = new QuestionAttachmentList(currentQuestionAttchaments)
