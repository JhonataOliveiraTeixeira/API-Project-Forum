...
describe('On answer Created', () => {
    ...
    beforeEach(() => {
        ...
        inMeoryQuestionAtachametRepository = new InMemoryQuestionAttachmentRepository()
        inMemoryQuestionrepository = new InMemoryQuestionRepository(inMeoryQuestionAtachametRepository)
        inMemorAnswerAttachmentRepository = new InMemoryAnswerAttachmentRepository()
        inMemoryAnswerRepository = new InMemoryAnswerRepository(inMemorAnswerAttachmentRepository)
